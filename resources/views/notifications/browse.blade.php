                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                          <a href="javascript:;" title="{{ __('origam_portal.generic.status') }}" class="btn btn-sm btn-{{ $data->status }} pull-right delete" data-id="{{ $data->{$data->getKeyName()} }}" id="delete-{{ $data->{$data->getKeyName()} }}">
